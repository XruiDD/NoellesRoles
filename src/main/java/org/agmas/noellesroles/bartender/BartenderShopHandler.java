    ...
    public static void register() {
        BuildShopEntries.EVENT.register((player, context) -> {
            ...
            if (gameWorld.isRole(player, Noellesroles.BARTENDER)) {
                ...
                context.addEntry(new ShopEntry(ModItems.VODKA.getDefaultStack(), 175, ShopEntry.Type.POISON));
                context.addEntry(new ShopEntry(ModItems.TEQUILA.getDefaultStack(), 75, ShopEntry.Type.POISON));
                context.addEntry(new ShopEntry(ModItems.WHISKEY.getDefaultStack(), 275, ShopEntry.Type.POISON));
